...
#' model using the \code{\link{ZIBR}} package. The zero-inflated beta
...
#' too small to fit a model to; please see \code{\link{ZIBR::zibr}} for more
#' information.
#'
#' @export
#' @seealso \code{zibClean}, \code{zibSim}
#'
#' @examples
#' library(zibFit)
